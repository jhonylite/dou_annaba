...
<div class="container-sm text-center">
    ...
    <div class="card">
        <div class="card-header">
            Déposer une demande de résidence
        </div>
        <div class="card-body">
        ...
        <form class="row g-3 justify-content-center" action="{{ route('send_demande') }}" method="POST">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Certificat d'orientation *</td>
                        <td><input required name="doc[]" required type="text" class="form-control" id="father"></td>
                    </tr>
                    <tr>
                        <td>image copiée *</td>
                    ...
                    <tr>
                        <td>Feuille de notes du baccalauréat *</td>
                        <td><input required name="doc[]" required type="text" class="form-control" id="father"></td>
                    </tr>
                    <tr>
                ...
                <div class="col-12">
                    ...
                    <div class="mt-2">
                    <a href="{{ route('student_demande_registered') }}" class="mt-3">Se réinscrire à la résidence</a>
                    </div>
                </div>
